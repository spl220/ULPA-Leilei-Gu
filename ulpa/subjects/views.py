...
def subject_search_results(request, *args, **kwargs):
    ...
    study_choices= ""
    intensities = ""
    study_choices_disable = ""
    intensities_disable = ""
    online_subjects = ""
    oncampus_subjects = ""
    online_regular_subjects = 0
    oncampus_regular_subjects = 0
    online_intensive_subjects = 0
    oncampus_intensive_subjects = 0
    number_of_pages = []
    ...
    if 'study_choices' in search_parameters:
        study_choices = request.GET.get('study_choices')
    if 'intensities' in search_parameters:
        intensities = request.GET.get('intensities')



    found_subjects = {}
    found_online_subjects = {}
    found_oncampuse_subjects = {}

    found_online_intensive_subjects = {}
    found_online_regular_subjects = {}
    found_oncampus_intensive_subjects = {}
    found_oncampus_regular_subjects = {}
    ...
    if len(request.GET):
        ...
        found_online_subjects = found_subjects.filter(study_choice__icontains="online"); 
        online_subjects = len(found_online_subjects);
        found_online_regular_subjects = found_online_subjects.filter(intensity__icontains="regular");
        online_regular_subjects = len(found_online_regular_subjects);
        found_online_intensive_subjects = found_online_subjects.filter(intensity__icontains="intensive");
        online_intensive_subjects = len(found_online_intensive_subjects);


        found_oncampus_subjects = found_subjects.filter(study_choice__icontains="on-campus");
        oncampus_subjects = len(found_oncampus_subjects);
        found_oncampus_regular_subjects = found_oncampus_subjects.filter(intensity__icontains="regular");
        oncampus_regular_subjects = len(found_oncampus_regular_subjects);
        found_oncampus_intensive_subjects = found_oncampus_subjects.filter(intensity__icontains="intensive");
        oncampus_intensive_subjects = len(found_oncampus_intensive_subjects);
    ...
    if (online_subjects == 0):
       study_choices_disable = "online"
    if (oncampus_subjects == 0):
       study_choices_disable = "on-campus"

    if 'study_choices_disable' in search_parameters:
        study_choices_disable = request.GET.get('study_choices_disable')
    if 'intensities_disable' in search_parameters:
        intensities_disable = request.GET.get('intensities_disable')
    ...
    context = {
        ...
        'study_choices_disable':study_choices_disable,
        'intensities_disable' : intensities_disable,
        'oncampus_subjects':oncampus_subjects,
        'online_subjects':online_subjects,
        'online_regular_subjects': online_regular_subjects,
        'oncampus_regular_subjects': oncampus_regular_subjects,
        'online_intensive_subjects':online_intensive_subjects,
        'oncampus_intensive_subjects': oncampus_intensive_subjects,
    }
